...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-9 h-9 flex items-center justify-center rounded-lg text-gray-400 hover:text-white hover:bg-white/10 dark:hover:bg-white/10 light:hover:bg-black/10 transition-all cursor-pointer"
